...
public class TriangleShape implements Shape {
    ...
    public TriangleShape(double[] xPoints, double[] yPoints, Color color) {
    ...
    public void setXPoints(double[] xPoints) {
        if (xPoints.length != 3) throw new IllegalArgumentException();
        this.xPoints = xPoints.clone();
    }
    public void setYPoints(double[] yPoints) {
        if (yPoints.length != 3) throw new IllegalArgumentException();
        this.yPoints = yPoints.clone();
    }
}
